...
create table T_PERSON (ID integer identity primary key, SURNAME_ID integer, FIRST_NAME varchar(50) not null, DATE_OF_BIRTH date, FATHER_ID integer, MOTHER_ID integer);
