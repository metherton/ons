...
insert into T_CENSUS_HOUSEHOLD (CENSUS_ID, LOCATION_ID) values (0,0);
insert into T_CENSUS_HOUSEHOLD (CENSUS_ID, LOCATION_ID) values (0,1);
...
insert into T_CENSUS_HOUSEHOLD_ENTRY (CENSUS_HOUSEHOLD_ID, PERSON_ID) values (2,3);
insert into T_CENSUS_HOUSEHOLD_ENTRY (CENSUS_HOUSEHOLD_ID, PERSON_ID) values (3,4);
